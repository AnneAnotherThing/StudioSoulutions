...
(function () {
  ...
  const ROSTER = {
    ...
    '309':  'Cuts From The Heart',  /* claimed via interest form 8/12/26, Leticia Gordon */
  ...
  /* 301 sits at the bottom of the right stack and 302 in the bottom-hall
     row. This was swapped the other way in the September round on a
     misread of Laura's August note, then put right on 2026-09-14 after
     Anne walked it: Deuces (suite 301) is physically the SECOND salon on
     your left coming in the main entrance, which is this stack-bottom
     spot, not the bottom-hall row. */
